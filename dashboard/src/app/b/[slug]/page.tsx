...
export async function generateMetadata(
  ...
  return {
    title,
    description: 'See what you actually spend on AI coding tools. Free, local-first CLI.',
    openGraph: { title, description: 'npx lmspend — free, open source, local-first.' },
